...
export function Nav() {
  ...
  return (
    <>
      ...
      {/*
        Keep the overlay outside <header>. backdrop-filter on the header creates a
        containing block that collapses position:fixed descendants to the bar height.
      */}
      <div
        id="mobile-menu"
        className={cn(
          "fixed inset-0 z-40 bg-white transition-opacity duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] lg:hidden",
          open ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0",
        )}
        aria-hidden={!open}
      >
        <div className="container-site flex h-full flex-col overflow-y-auto pb-10 pt-24">
